      ...
      <div className="mx-auto p-4">
        <div className="flex flex-wrap justify-center mb-4">
          <div className="w-full md:w-1/2 sm:w-full p-6">
            <h5 className="uppercase text-white mb-2">About Us</h5>
          ...
          <div className="w-full md:w-1/2 sm:w-full p-6">
            ...
            <ul>
              <li className='text-white'>
                <input type="email" name="email" id="email" placeholder='send us an email' className="w-full md:w-1/2 sm:w-full" />
                Email:info@afriquecine.com
              </li>
              <li className='text-white'>
                Phone: +234020356789
              </li>
